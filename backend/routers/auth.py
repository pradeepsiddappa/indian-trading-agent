...
from backend.auth import CSRF_COOKIE, SESSION_COOKIE, cookie_secure, make_session, public_mode, secret_matches, valid_session
...
def login(data: LoginRequest):
    ...
    authenticated = username_ok if expected_username and public_mode() else username_ok or secret_ok
...
def status(request: Request):
    """Return session state without returning any secret or token material."""
